...
<template>
 ...
 <div class="mt-8 bg-white overflow-hidden shadow sm:rounded-lg p-6">
    <h2 v-if="post" class="text-2xl leading-7 font-semibold">
      {{ post.title.rendered }}
    </h2>
    <p v-if="post" class="mt-3 text-gray-600" :class="{ 'my-class': isMyClass }" v-html="post.content.rendered"></p>
    <div v-else>
      Loading...
    </div>
  </div>
...
export default {
  ...
  async fetch() {
    ...
    this.postId = postId
    const url = `https://myblog.nufat.id/wp-json/wp/v2/posts/${postId}`
